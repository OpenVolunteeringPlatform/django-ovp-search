...
setup(
    ...
    download_url='https://github.com/OpenVolunteeringPlatform/django-ovp-search/tarball/1.0.16',
    license='AGPL',
    ...
    install_requires = [
      ...
      'ovp-projects>=1.2.12,<1.1.0',
      'ovp-users>=1.1.8,<2.0.0',
      'ovp-core>=1.2.7,<2.0.0',
      'ovp-uploads>=1.0.4,<2.0.0',
      'ovp-organizations>=1.0.13,<2.0.0',
